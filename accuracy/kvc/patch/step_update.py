...
class QuestUpdater(StepUpdater):
    ...
    def reset(self, input: torch.Tensor):
        for layer in self.model.model.layers:
            ...
            layer.self_attn._quest_token_select_score_events = []
            layer.self_attn._quest_token_select_topk_events = []
    ...
    def finish(self):
        ...
        layer_token_select_score_ms = []
        layer_token_select_topk_ms = []
        layer_token_pack_ms = []
        layer_attn_compute_ms = []
        layer_token_select_calls = []
        layer_token_select_score_calls = []
        layer_token_select_topk_calls = []
        ...
        for layer in self.model.model.layers:
            ...
            score_events = getattr(attn, "_quest_token_select_score_events", [])
            topk_events = getattr(attn, "_quest_token_select_topk_events", [])
            ...
            for start_evt, end_evt in score_events:
                score_ms += float(start_evt.elapsed_time(end_evt))
            for start_evt, end_evt in topk_events:
                topk_ms += float(start_evt.elapsed_time(end_evt))
            ...
            layer_token_select_score_ms.append(score_ms)
            layer_token_select_topk_ms.append(topk_ms)
            layer_token_pack_ms.append(pack_ms)
            layer_attn_compute_ms.append(attn_ms)
            layer_token_select_calls.append(len(select_events))
            layer_token_select_score_calls.append(len(score_events))
            layer_token_select_topk_calls.append(len(topk_events))
        ...
        return {
            ...
            "token_select_score_ms": float(sum(layer_token_select_score_ms)),
            "token_select_topk_ms": float(sum(layer_token_select_topk_ms)),
            ...
            "token_select_score_calls": int(sum(layer_token_select_score_calls)),
            "token_select_topk_calls": int(sum(layer_token_select_topk_calls)),
            ...
            "layer_token_select_score_ms": layer_token_select_score_ms,
            "layer_token_select_topk_ms": layer_token_select_topk_ms,
            ...
            "layer_token_select_score_calls": layer_token_select_score_calls,
            "layer_token_select_topk_calls": layer_token_select_topk_calls,
